...
function App() {
  return (
    <div className="grow min-h-screen py-16 md:p-16">
      <div className="text-foreground grid grid-cols-8 gap-8 mx-6 md:mx-auto md:max-w-5xl">
        <Link
          to="/"
          className="text-foreground underline hover:no-underline underline-offset-4 col-span-6 text-sm md:text-base"
        >
          Zhuo Jinggang
        </Link>
        ...
        <div className="flex flex-col gap-2 col-span-2 md:col-span-1 text-sm">
          <span>Email:</span>
          <span>GitHub:</span>
          <span>Work:</span>
        </div>

        <div className="flex flex-col gap-2 col-span-6 md:col-span-3 text-sm">
          <a
